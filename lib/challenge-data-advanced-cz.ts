...
"Pomoz mi zachytit klíčové věci z tohoto pracovního týdne. Zeptej se mě na 5 otázek zaměřených na: co fungovalo, co nefungovalo, jaké rozhodnutí jsem udělal/a a proč, co mě překvapilo a co se budu chtít příště udělat jinak."
...
5. Draft reportu: co fungovalo v struktuře, co bylo nejasné (Proč: základ pro šablonu).`,
    taskTip:
      "Pracuj přímo v Claude, ChatGPT nebo Gemini – výsledek si ulož do Notion, Google Docs nebo Apple Notes.",
    teaser:
      "Zítra si ukážeme, co s tím surovým materiálem udělat – krok Clean: zpracování ≠ uložení.",
  },
  {
    day: 3,
    ...
    concept: [
      ...
      [
        ...
        "Hromada poznámek → sada přehledných záznamů s kategoriemi",
      ],
...
Kroky: Otevři zápis → strukturuj → napiš follow-up email → pošli.
Závislosti: Mírné.
...
Krok 1 — Kontext:
Vstup: Popis schůzky + agenda
AI prompt: "Shrň, co je cílem této schůzky a co potřebuji vědět nebo rozhodnout. Jaké otázky by měly být zodpovězeny?"
...
Co jsem se dozvěděl/a: Neměl/a jsem zmapovanou spokojenost zákazníků s aktuálním servisem. To je první krok před jakýmkoliv rozhodnutím.`,
  ...
  },
  {
    ...
    concept: [
      ...
      "Lidská paměť je skvělá na rozpoznávání. Horší je na přesné zachytávání. AI ti pomáhá systémem, který nezapomíná: zachytí rozhodnutí, kontext, výsledky, formáty. Nejsilnější využití je kombinace šablon + AI sumarizace + pravidelné ukládání — vznikne systém, kde nic neproklouzne.",
...
AI výstup po feedbacku: Brief připravený k použití. Celý proces: 35 minut. Výsledek, který by ručně trval 2–3 hodiny.`,
  ...
  },
  {
    ...
    concept: [
      ...
      "Připomínka pěti superschopností: Perception (vidíš vzory), Intelligence (lepší rozhodnutí), Memory (nic neproklouzne), Creation (výstupy na jiné úrovni), Connection (komunikace přizpůsobená situaci).",
    ],
...
Memory (2/5): Zatím nepoužívám systematicky. Vím, že schůzky jsou slabé místo. Další krok: příští schůzka → zápis přes AI do 10 minut po ní.
...
Connection (3/5): Použil/a jsem pro přípravu zpětné vazby — velmi užitečné. Chci rozšířit na obtížné rozhovory. Další krok: příští obtížný rozhovor připravit s AI předem.`,
    taskTip: "Pracuj přímo v Claude, ChatGPT nebo Gemini – výsledek si ulož do Notion, Google Docs nebo Apple Notes.",
...
Výsledek: Jasně víš, kde musíš být a kde ti AI šetří čas. Nic neproklouzne.`,
  ...
  },
  {
    ...
    taskIntro: "Vyber si jeden opakující se proces z tvé práce a popiš ho v tomto formátu:",
    taskItems: [
...
Příklad: Přijde na schůzku, zmíní, že má problém s přípravou agendy. Ty otevřeš Claude, zadáš cíl schůzky a za 2 minuty máš strukturu. Nedej to kolegovi jako 'AI tě naučím' — jen řekni 'zkus tento prompt'. Nic více není potřeba.
...
2. Rozhodování — teď si ke každému většímu rozhodnutí vyžádám analýzu od AI jako myšlenkového partnera.
